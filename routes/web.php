...
//LANDING
Route::get('/', 'App\Http\Controllers\WelcomeController@index')->middleware(['TrackVisitor']);
...
//PRODUK DEPAN
Route::get('/produk-detail/{id}', 'App\Http\Controllers\ProdukController@detail')->middleware(['TrackVisitor']);
...
//PRODUK DEPAN
Route::get('/berita-detail/{id}', 'App\Http\Controllers\BeritaController@detail')->middleware(['TrackVisitor']);
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['middleware' => 'checkRole:Admin'], function () {
        ...
        //VISITOR
        Route::get('/back/visitor', 'App\Http\Controllers\VisitorController@index');
        Route::get('/back/data-visitor', 'App\Http\Controllers\VisitorController@data');
    });
